...
The concentration plots show the viral load in the wastewater over time, with and without normalization by flow. The normalized concentration plot removes the noise due to daily flow variation, allowing for a clearer view of the viral load dynamics.

We include the concentration plots for the original and log10-transformed data to compare the results. The log10 transformation is useful transformation since it compresses the data range and reduce the impact of large variations.
...
concentration_rw_plot <- plot_concentration(ww_result_rw, 
      ...
      labs(title = "Viral Concentration Over Time (Random Walk)")
...
concentration_rw_norm_plot <- plot_concentration(ww_result_rw, 
      ...
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +  
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Normalized Viral Concentration Over Time (Random Walk)")
...
concentration_rw_plot_log10 <- plot_concentration(ww_result_log10_rw, 
      ...
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +  
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Log10-Transformed Viral Concentration (Random Walk)")
...
concentration_rw_norm_plot_log10 <- plot_concentration(ww_result_log10_rw, 
      ...
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +  
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Log10-Transformed Normalized Viral Concentration (Random Walk)")
...
names(concentration_plots_list) <- c("Concentration Random Walk", 
                                    "Normalized Concentration Random Walk",
                                    "Concentration (log10) Random Walk", 
                                    "Normalized Concentration (log10) Random Walk" #, 
...
Rt_rw <- plot_R(ww_result_rw, forecast = TRUE) +
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +  
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +  
      labs(title = "Estimated Effective Reproduction Number (Rt) Over Time (Random Walk)",  
...
# Add names to the plots in the list
names(Rt_plot_list) <- c("Rt Random Walk") #, "Rt Spline")
...
Load_rw <- plot_load(ww_result_rw) +
      ...
      labs(title = "Estimated Viral Load Over Time (Random Walk)", 
           x = "Date", y = "Viral Load [gc/mL]")

# Load_spline <- plot_load(ww_result_spline) +
#       scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") + 
#       theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
#       labs(title = "Estimated Viral Load Over Time (Spline)", 
#            x = "Date", y = "Viral Load [gc/mL]")

Load_log10_rw <- plot_load(ww_result_log10_rw) +
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Log10-Transformed Viral Load Over Time (Random Walk)", 
           x = "Date", y = "Log10(Viral Load)")

# Load_log10_spline <- plot_load(ww_result_log10_spline) +
#       scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +
#       theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
#       labs(title = "Log10-Transformed Viral Load Over Time (Spline)", 
#            x = "Date", y = "Log10(Viral Load)")

Load_plot_list <- list(Load_rw,  Load_log10_rw) #, Load_spline, Load_log10_spline)

names(Load_plot_list) <- c("Load Random Walk",  "Load Log10 Random Walk") #, "Load Spline", "Load Log10 Spline")
...
Infection_rw <- plot_infections(ww_result_rw) +
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Estimated Infections Over Time (Random Walk)", 
           x = "Date", y = "Infections")
...
Infection_log10_rw <- plot_infections(ww_result_log10_rw) +
      scale_x_date(date_labels = "%b %Y", date_breaks = "1 months") +
      theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
      labs(title = "Log10-Transformed Infections Over Time (Random Walk)", 
           x = "Date", y = "Infections")
...
names(Infection_plot_list) <- c("Infection Random Walk", 
                                "Infection Log10 Random Walk") #, "Infection Spline", "Infection Log10 Spline")
...
# ww_result_spline$fitted$diagnostic_summary()
```

+--------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Diagnostic                                                         | Description                                                                                                                                                                                                                                                   | Results         | Interpretation                                                                                                                                                                                |
+:===================================================================+:==============================================================================================================================================================================================================================================================+:================+:==============================================================================================================================================================================================+
| `num_divergent`: Number of Divergent Transitions                   | Divergences indicate areas where the sampler failed to approximate the target distribution accurately, often due to issues with step size resolution.                                                                                                         | Chain 1: 0      | No divergent transitions were detected in any of the chains, suggesting that the sampler did not encounter issues with the step size resolution.                                              |
|                                                                    |                                                                                                                                                                                                                                                               |                 |                                                                                                                                                                                               |
|                                                                    |                                                                                                                                                                                                                                                               | Chain 2: 0      |                                                                                                                                                                                               |
|                                                                    |                                                                                                                                                                                                                                                               |                 |                                                                                                                                                                                               |
|                                                                    |                                                                                                                                                                                                                                                               | Chain 3: 0      |                                                                                                                                                                                               |
